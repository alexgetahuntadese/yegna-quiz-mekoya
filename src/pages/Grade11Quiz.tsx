        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardContent className="text-center py-8">
              <p className="text-gray-500">No questions available for this Grade 11 chapter and difficulty level.</p>
              <Button 
                onClick={() => navigate(`/grade11/${subject}`)} 
                variant="outline"
                className="mt-4"
              >
                Back to Subject
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-2 border-amber-200">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-gray-800">Grade 11 Quiz Completed!</CardTitle>
              <CardDescription>
            ...
            <CardContent className="text-center">
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Button onClick={() => navigate(`/grade11/${subject}`)}>
                  Back to Subject
                </Button>
              </div>
            </CardContent>
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between items-center mb-4">
            <Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white">
              Grade 11 - {difficulty?.toUpperCase()}
            </Badge>
